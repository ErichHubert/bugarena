...
- overwrite `/workspace/AGENTS.md` from the image on every container start
...
## Flow
1. start container
2. entrypoint does harmless idempotent setup, overwrites `/workspace/AGENTS.md` from the image baseline, and reminds the user to read it
3. run `codex login`
